...
type advancedCoinClient struct {
	cc grpc.ClientConnInterface
}

func NewBrunoCoinClient(cc grpc.ClientConnInterface) BrunoCoinClient {
	return &advancedCoinClient{cc}
}

func (c *advancedCoinClient) ForwardTransaction(ctx context.Context, in *Transaction, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *advancedCoinClient) ForwardBlock(ctx context.Context, in *Block, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *advancedCoinClient) Version(ctx context.Context, in *VersionRequest, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
	err := c.cc.Invoke(ctx, "/BrunoCoin/Ver", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *advancedCoinClient) GetBlocks(ctx context.Context, in *GetBlocksRequest, opts ...grpc.CallOption) (*GetBlocksResponse, error) {
...
func (c *advancedCoinClient) GetData(ctx context.Context, in *GetDataRequest, opts ...grpc.CallOption) (*GetDataResponse, error) {
...
func (c *advancedCoinClient) SendAddresses(ctx context.Context, in *Addresses, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (c *advancedCoinClient) GetAddresses(ctx context.Context, in *Empty, opts ...grpc.CallOption) (*Addresses, error) {
	out := new(Addresses)
